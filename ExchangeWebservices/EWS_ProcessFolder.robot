...
Make sure in the converter you select the default page encoding. Here it defaults to utf-8.</property>
      ...
      <object class="Group" id="99">
        ...
        <steps class="ArrayList">
          ...
          <object class="Transition" serializationversion="3" id="103">
            <property name="name" class="String" id="104">Store in Database</property>
      ...
      <object class="Group" id="106">
        ...
        <steps class="ArrayList">
          ...
          <object class="Group" id="146">
            <name class="String">EWS:Move to Folder</name>
            <comment>
              <null/>
            </comment>
            <blockBeginStep class="BlockBeginStep" id="147"/>
            <steps class="ArrayList">
            ...
            <blockEndStep class="BlockEndStep" id="156"/>
            <edges class="ArrayList">
              <object class="TransitionEdge">
                <from idref="147"/>
                <to idref="148"/>
